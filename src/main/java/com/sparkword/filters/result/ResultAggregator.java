 ...
 */
package com.sparkword.filters.result;

import com.sparkword.filters.util.TextNormalizer;
import com.sparkword.filters.word.WordFilterMode;
import com.sparkword.filters.word.engine.AhoCorasickEngine.Match;
...
public class ResultAggregator {
    ...
    public FilterResult aggregate(Map<WordFilterMode, List<Match>> matchesByMode) {
        ...
        if (matchesByMode.containsKey(WordFilterMode.STRONG)) allMatches.addAll(matchesByMode.get(WordFilterMode.STRONG));
        if (matchesByMode.containsKey(WordFilterMode.NORMAL)) allMatches.addAll(matchesByMode.get(WordFilterMode.NORMAL));
